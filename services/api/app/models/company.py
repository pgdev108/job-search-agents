...
class Company(Base):
    ...
    ticker: Mapped[str | None] = mapped_column(String, nullable=True, unique=True, index=True)
    ...
    # User-defined tags (comma-separated tag names, e.g. "bay_area,target")
    company_tags: Mapped[str | None] = mapped_column(String, nullable=True)
    ...
    __table_args__ = (
        ...
        Index("idx_company_tags", "company_tags"),
    )
